...
public struct InputInfo
{
    ...
    public List<ButtonInput> ReturnListOfCurrentButtonInputs()
    {
        List<ButtonInput> buttonInputs = new List<ButtonInput>();

        for (int i = 0; i < currentButtonInputs.buttonInputs.Count; i++)
        {
            if (currentButtonInputs.buttonInputs[i].buttonState == true)
            {
                buttonInputs.Add(currentButtonInputs.buttonInputs[i]);
            }
        }
